...
for r in range(Nr):
    ...
    if r==0:
            p = lmfit.Parameters()
            p.add_many(('nc', 1,True,0.7,1),('ns', 0,True,0,0.3), ('Tc_pal', 10*10**5,True,1*10**5,10*10**5), ('Tc_per', 10*10**5,True,1*10**5,10*10**5), ('Ts_pal', 15*10**5,True,1*10**5,20*10**5), ('Ts_per', 15*10**5,True,1*10**5,20*10**5), ('Uc',0,True,-0.4,0),('Us',0.2,True,0,1.5),('kappac',10,True,4,50),('kappas',10,True,2,50))
