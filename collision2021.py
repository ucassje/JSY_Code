...
for r in range(Nr):
   ...
   plt.text(pal_v[Nv-1],-0.,r'$\mathcal{v}_\parallel/\mathcal{v}_{Ae0}$', fontsize=12)
   plt.text(-0.,pal_v[Nv-1],r'$\mathcal{v}_\perp/\mathcal{v}_{Ae0}$', fontsize=12)
   plt.text(pal_v[Nv-9],pal_v[Nv-2], r'$r/r_s=$' "%.2f" % z[r], fontsize=20)
