...
for r in range(Nr):
    p = lmfit.Parameters()
    p.add_many(('nc', 0.9,True,0.5,1),('ns', 0.05,True,0,0.5), ('Tc_pal', 5*10**5,True,1*10**5,10*10**5), ('Ts_pal', 8*10**5,True,1*10**5,10*10**5), ('Ts_per', 8*10**5,True,1*10**5,10*10**5), ('Uc',-0.1,True,-0.4,0),('Us',r*0.05,True,0,1.5),('kappac',10,True,8,20),('kappas',3,True,2,10))
